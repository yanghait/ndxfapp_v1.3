package com.ynzhxf.nd.firecontrolapp.view.compentent;
...
import com.ynzhxf.nd.firecontrolapp.adapter.SearchProjectAdapter;
import com.ynzhxf.nd.firecontrolapp.bean.PagingBean;
import com.ynzhxf.nd.firecontrolapp.bean.ResultBean;
import com.ynzhxf.nd.firecontrolapp.bean.nodebase.BaseNodeBean;
...
import com.ynzhxf.nd.firecontrolapp.view.basenode.ChargeProjectInfoActivity;
...
public class CompententSearchProjectActivity extends BaseActivity implements SearchProjectAdapter.ISearchProjectClick,ICompententSearchProjectPersenter.ICompententSearchProjectView{
    ...
    public void SearchProjectItemClick(ProjectNodeBean query) {
        Intent intent  = new Intent(this, ChargeProjectInfoActivity.class);
    ...
    public void callBackCompententSearchProject(ResultBean<PagingBean<ProjectNodeBean>, String> result) {
        try{
            ...
            HelperView.Toast(this ,"查找失败:" + e.getMessage());
        }

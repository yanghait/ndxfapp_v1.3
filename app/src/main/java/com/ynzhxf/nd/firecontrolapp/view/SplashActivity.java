package com.ynzhxf.nd.firecontrolapp.view;
...
import com.ynzhxf.nd.firecontrolapp.presenter.platform.impl.PlatfromPersenterFactory;
            ...
            public void run() {
                try {
                    ...
                    if (isSuccess) {
                        ...
                        intent = new Intent(SplashActivity.this, com.ynzhxf.nd.firecontrolapp.login.LoginActivity.class);
                        if (isFromClickPush) {
                            intent.putExtra("isFromClickPush", true);
                            intent.putExtra("TypeId", typeId);
                            intent.putExtra("MessageType", relationId);
    ...
    public void callBackError(ResultBean<String, String> resultBean, String code) {
        ...
        switch (code) {
            case IVersionCheckPersenter.TAG:
                ...
                Intent intent = new Intent(SplashActivity.this, com.ynzhxf.nd.firecontrolapp.login.LoginActivity.class);
                startActivity(intent);
                break;
        }
    }

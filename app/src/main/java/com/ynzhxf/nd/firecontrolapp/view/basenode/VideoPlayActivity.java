...
import com.ynzhxf.nd.firecontrolapp.tool.utils.Config;
import com.ynzhxf.nd.firecontrolapp.tool.utils.Utils;
import com.ynzhxf.nd.firecontrolapp.tool.widget.MediaController;
 ...
 * 视频播放页面
 */
public class VideoPlayActivity extends BaseActivity implements IVideoPlayPersenter.IVideoPlayView, IVideoPlayHeartPersenter.IVideoVideoPlayHeartView {
        ...
        public boolean onError(int errorCode) {
            ...
            switch (errorCode) {
                case PLOnErrorListener.ERROR_CODE_IO_ERROR:
                    Utils.showToastTips(VideoPlayActivity.this, "网络异常!");
                    progressDialog.dismiss();
                    return false;
                case PLOnErrorListener.ERROR_CODE_OPEN_FAILED:
                    Utils.showToastTips(VideoPlayActivity.this, "播放器打开失败 !");
                    progressDialog.dismiss();
                    break;
                case PLOnErrorListener.ERROR_CODE_SEEK_FAILED:
                    Utils.showToastTips(VideoPlayActivity.this, "拖动失败!");
                    break;
                default:
                    Utils.showToastTips(VideoPlayActivity.this, "未知类型异常 !");
                    progressDialog.dismiss();
                    break;
            }
            finish();
    ...
    private PLOnCompletionListener mOnCompletionListener = new PLOnCompletionListener() {
        ...
        public void onCompletion() {
            ...
            Utils.showToastTips(VideoPlayActivity.this, "Play Completed !");

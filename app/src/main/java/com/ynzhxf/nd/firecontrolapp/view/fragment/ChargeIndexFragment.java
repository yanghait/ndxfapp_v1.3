...
import com.ynzhxf.nd.firecontrolapp.bean.common.ChargeIndexBarChartBean;
...
import com.ynzhxf.nd.firecontrolapp.ui.MyMarkView;
import com.ynzhxf.nd.firecontrolapp.ui.SpecialLoadHeader;
import com.ynzhxf.nd.firecontrolapp.ui.XValuesFormatter;
...
import com.ynzhxf.nd.firecontrolapp.view.basenode.charge.ChargeIndexPageSelectedActivity;
import com.ynzhxf.nd.firecontrolapp.view.compentent.CompententAreaActivity;
import com.ynzhxf.nd.firecontrolapp.view.compentent.CompententAreaCoutryActivity;
...
public class ChargeIndexFragment extends BaseFragment implements View.OnClickListener, ICompententAreaPersenter.ICompententAreaView {
    ...
    private void initEventCount() {
        ...
        HashMap<String, String> params = new HashMap<>();
        params.put("Token", new PreferencesService().getToken());
